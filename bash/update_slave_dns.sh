...
scp server_config@centos7-l01:/home/lukepafford/Documents/iac_config/configuration_files/dns/slave_named.conf ~

# Replace named conf file and set proper permissions
sudo /usr/bin/mv /home/server_config/slave_named.conf /etc/named.conf
